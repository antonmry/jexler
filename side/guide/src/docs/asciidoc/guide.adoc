...
* The jexler-core JAR is at http://search.maven.org/#search%7Cga%7C1%7Cjexler-core[Maven Central]
* The jexler webapp is at https://sourceforge.net/projects/jexler/[Sourceforge] (see "Files" tab)
* The website http://www.jexler.net/[www.jexler.net] hosts http://www.jexler.net/groovydoc/[Groovydoc],
