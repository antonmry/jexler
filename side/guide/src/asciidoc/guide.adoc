...
An older workaround is still configurable, but be aware that it only reduces
the chance of the issue occurring, but does not fully fix it:
...
Activating all three properties is possible without any problems.
