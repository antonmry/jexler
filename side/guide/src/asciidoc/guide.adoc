...
=== CentOS / Tomcat Startup

On CentOS with Tomcat 7 had the following issue: Serveral jexlers
...
classes needed by the utility jexler could not be found (NoClassDefFoundError).
Using the wait time above improved things somewhat, but the following solved it.

In the utility jexler:
