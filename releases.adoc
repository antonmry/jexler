...
* GUI setting in separate settings files, no longer in web.xml.
* Easier customization of web GUI.
* Various refinements.
...
* Access to binding variables with 'jexlerBinding' instead
  of with 'Jex.vars'.
* Hopefully done again for a while now...
